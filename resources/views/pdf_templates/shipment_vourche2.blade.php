...
<body>
    <div id="page-wrap" style="color:#3c3c3c">
                ...
                <div class="col-md-6 align_right">
                    ...
                    <div class="col-xs-12" style="margin-top:2px;">
                        ...
                        <span style="font-size:12pt;font-weight:normal;font-style:normal;color:#3c3c3c">
                            ...
                            @php
                                $numb_zero = 4 - strlen($order_details[0]->order_header_id);
                                $code_rank = '';
                                for ($i = 1; $i <= $numb_zero; $i++) {
                                    $code_rank .= '0';
                                }
                                $code_invoice = date_create()->format('Ymd') . '-' . $code_rank . $order_details[0]->order_header_id;
                            @endphp
                        </span>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <span
                            style="font-size:14px;font-weight:normal;font-style:normal;color:#3c3c3c">{{ @Auth::user()->name }}</span>
                    </div>
                </div>
                <div id="customer">
                    <table id="meta" style="margin-top:-30px;">
                        <tr>
                            ...
                            @php
                                ...
                                $total_not_tax += $order_details[0]->order_header->fee_shipping + $order_details[0]->order_header->fee_daibiki;
                                $tax = $total_not_tax * $order_details[0]->tax->tax;
                            @endphp
                            <td>{{ format_number($total_not_tax, $order_details[0]->order_header->type_money) }}
                                {{ $type_money }}</td>
                        </tr>
                        <tr>
                            <td class="meta-head">消費税<span>( {{ $order_details[0]->tax->tax * 100 }} %)</span></td>
                            <td>{{ format_number($tax, $order_details[0]->order_header->type_money) }}
                                {{ $type_money }}</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="due">
                                    {{ format_number($total_not_tax + $tax, $order_details[0]->order_header->type_money) }}
                                    &nbsp; {{ $type_money }}</div>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="col-md-12">
            ...
            <table id="items">
                <tr>
                    <td class="column_one" style="font-size:10pt;font-weight:normal;color:black"></td>
                    <td class="column_two" style="font-size:10pt;font-weight:normal;color:black">注文番号</td>
                    <td class="column_three" style="font-size:10pt;font-weight:normal;color:black">品種</td>
                    <td class="column_four" style="font-size:10pt;font-weight:normal;color:black">型式</td>
                    <td class="column_five" style="font-size:10pt;font-weight:normal;color:black">数量</td>
                    <td class="column_six" style="font-size:10pt;font-weight:normal;color:black">単位</td>
                    <td class="column_seven" style="font-size:10pt;font-weight:normal;color:black">単価</td>
                    <td class="column_eight" style="font-size:10pt;font-weight:normal;color:black">金額</td>
                </tr>
                @php
                    $total_money = 0;
                    $fee_daibiki = 0;
                ...
                @foreach ($order_details as $key => $item)
                    ...
                    <tr class="item-row {{ $class_top }}">
                        @if ($key == 0)
                            <td class="column_one" rowspan="{{ count($order_details) * 2 }}"
                        ...
                        <td class="column_three" style="font-size:10pt;font-weight:normal;">
                            {{ $item->order_header->rank_quote }}</td>
                ...
                <tr class="item-row">
                    ...
                    <td class="column_seven" style="font-size:10pt;font-weight:normal;">
                        {{ number_format($order_details[0]->order_header->fee_shipping) }}</td>
                    <td class="column_eight" style="font-size:10pt;font-weight:normal;">
                        {{ number_format($order_details[0]->order_header->fee_shipping) }} {{ $type_money }}</td>
                </tr>
                ...
                <tr class="item-row">
                    ...
                    <td class="column_six" style="font-size:10pt;font-weight:normal;">式</td>
                    <td class="column_seven" style="font-size:10pt;font-weight:normal;">
                        {{ number_format($order_details[0]->order_header->fee_daibiki) }}</td>
                    <td class="column_eight" style="font-size:10pt;font-weight:normal;">
                        {{ number_format($order_details[0]->order_header->fee_daibiki) }} {{ $type_money }}</td>
                </tr>
                <tr class="item-comment">
                    <td colspan="7" class="comment" style="font-size:10pt;font-weight:normal;">[備考]</td>
                </tr>
