<div class="modal fade" id="send-mail-to-customer-modal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width: 600px !important">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row justify-content-center w-100">
                    <div class="col-12 input-group input-group-sm mb-1">
                        ...
                        <input type="text" id="shipment-customer-email" class="form-control" aria-label="Small"
                ...
                <div class="row justify-content-center w-100">
                    <div class="col-12">
                        ...
                        <textarea id="customer-mail-content" class="form-control mt-2" name="email_content"
            ...
            <div class="modal-footer"
                ...
                <button type="button" id="shipment-customer-btn" class="btn btn-primary btn-sm">送信</button>
            </div>
        </div>
    </div>
</div>
