<div class="col-10 table-responsive">
    <table id="supplier-info" class="table table-bordered table-striped table-sm">
        <tbody>
            <tr>
                <td class="w-15">仕入先名</td>
                <td id="supplier-id" class="w-35"></td>
                <td class="w-15">POキャンセル数</td>
            ...
            <tr>
                ...
                <td id="supplier-pay-term" class="w-35"></td>
    ...
    <div class="row justify-content-center align-items-center" style="color: black">
        ...
        <div class="col-8"><textarea class="form-control w-100 message-box"></textarea></div>
    </div>
</div>
